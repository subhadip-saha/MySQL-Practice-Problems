CREATE DATABASE dac_2021;	-- create a new database

SHOW DATABASES;			-- show the existing database names

USE dac_2021;			-- currently working with this database

SELECT database();		-- current active database
